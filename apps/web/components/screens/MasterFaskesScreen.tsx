    ...
    <RouteGuard permission={AccessPermission.MASTER_DATA_READ}>
      <div className="min-w-0 space-y-6 sm:space-y-8">
        <PageHeader
          ...
          description="Ikhtisar struktur lokal sebelum dipetakan ke resource SATUSEHAT: organisasi/faskes dan lokasi fisik."
          action={
            <Button
              type="button"
              variant="secondary"
        ...
        <div className="flex items-start gap-2 rounded-[var(--radius-card)] border border-info/20 bg-info/5 p-4 text-xs text-info">
          ...
          <p>
            ...
            sub-organisasi dan Location disinkronkan ke
