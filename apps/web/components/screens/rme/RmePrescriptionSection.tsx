...
import type { RmePrescription, RmePrescriptionField, RmePresetBundle } from './types';
  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Button type="button" variant="secondary" size="sm" onClick={onAddPrescription} className="border-primary/20 text-xs font-semibold text-primary">
            ...
            <div key={index} className="grid grid-cols-1 gap-3 rounded-[var(--radius-card)] border border-border bg-background p-3 sm:grid-cols-4">
              <div className="sm:col-span-2">
                <Input
                  ...
                  onChange={(event) => onUpdatePrescription(index, 'medicineName', event.target.value)}
              ...
              <div>
                <Input
                  ...
                  onChange={(event) => onUpdatePrescription(index, 'frequency', event.target.value)}
              ...
              <div>
                <Input
                  ...
                  onChange={(event) => onUpdatePrescription(index, 'quantity', Number(event.target.value))}
                  placeholder="Jumlah"
